...
alias sbcl="rlwrap ~/.bin/sbcl --no-sysinit"
alias tar="tar --owner 0 --group 0"
alias maxima="PATH='/home/cfy/perl5/bin:/usr/local/bin:/usr/bin:/bin:/opt/bin:/usr/x86_64-pc-linux-gnu/gcc-bin/4.5.3:/usr/games/bin' maxima"
